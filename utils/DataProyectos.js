export const DataProyectos = [
  {
    ...
    <li>
      <span style="color: initial;">CONCEPTO SMART</span>
    </li>
    <li>1, 2 y 3 DORMITORIOS</li>
  </ul>`,
    Plantas: [
      {
        id: 1,
    ...
    Plantas: [
      {
        ...
        size: 56,
        image: "/Planta/Sienna/SA101.png",
      },
      {
        id: 4,
        name: " Flat tipo B - 102",
        size: 62.02,
        image: "/Planta/Sienna/SB102.png",
      },
      {
        id: 1,
        name: "Flat tipo C - 201 al 801  ",
        size: 41.46,
        image: "/Planta/Sienna/SC201801.png",
      },
      {
        id: 2,
        name: "Flat tipo D - 202 al 802  ",
        size: 70.5,
        image: "/Planta/Sienna/SD202802.png",
      },

      {
        id: 5,
        name: " Flat tipo E - 203 al 803 ",
        size: 63.16,
        image: "/Planta/Sienna/SE203803.png",
      },
      {
        id: 6,
        name: " Flat tipo F - 901",
        size: 41.15,
        image: "/Planta/Sienna/SF901.png",
      },
      {
        id: 7,
        name: "Duplex tipo G - 902",
        size: 132.99,
  ...
  },
  {
    ...
    Direction: "Magdalena del Mar, Lima, Lima Metropolitana, Lima, 15076, Perú",
    Description: `<ul><li>Triplex desde 138m2 hasta 152m2</li><li>Flats desde 100 m2 hasta  136 m2</li><li>Lobby con sala de espera</li><li>Terraza</li><li>Zona de BBQ</li><li>Estacionamiento de bicicletas</li><li>3 y 4 habitaciones</li><li>Frente a parque</li><li>En el corazón del centro cosmopolita de lima</li><li>Cercano a universidades y centros educativos</li></ul>`,
    Plantas: [
      {
        id: 1,
        name: "Flat 102",
        size: 92.85,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT102.jpg",
      },
      {
        id: 2,
        name: " Flat 201",
        size: 97.56,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT201.jpg",
      },
      {
        id: 3,
        name: " Flat 202",
        size: 100.1,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT202.jpg",
      },
      {
        id: 4,
        name: " Flat 301",
        size: 97.56,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT301.jpg",
      },
      {
        id: 5,
        name: " Flat 302",
        size: 100.1,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT302.jpg",
      },
      {
        id: 6,
        name: " Flat 401        ",
        size: 97.56,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT401-1.jpg",
      },
      {
        id: 7,
        name: " Flat 402",
        size: 100.1,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/FLAT402.jpg",
      },
      {
        id: 8,
        name: " Triplex 501",
        size: 144.9,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/triplex501.jpg",
      },
      {
        id: 9,
        name: " Triplex 502",
        size: 152.75,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/triplex502.jpg",
      },
      {
        id: 10,
        name: " Triplex 503",
        size: 138.86,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/triplex503.jpg",
      },
      {
        id: 11,
        name: " Triplex 504        ",
        size: 138.86,
        image:
          "https://jkinmobiliaria.com/wp-content/uploads/2023/01/triplex504.jpg",
      },
    ],
    Type: "Flat, Triplex    ",
  },
